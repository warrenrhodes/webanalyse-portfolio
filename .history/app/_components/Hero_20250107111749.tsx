  ...
  return (
    <Section className="flex items-start gap-3 py-0 max-md:flex-col">
      <div className="flex flex-[2] flex-col gap-2">
        ...
        <button
          type="button"
          className="flex items-center gap-2 w-48 h-12 rounded-2xl bg-primary/15 text-center font-sans text-xl font-semibold ring-1 cursor-pointer hover:bg-primary/30"
          onClick={downloadResume}
        >
          <LinkIcon />

          <p className=" text-primaryl">{localization.download}</p>
        </button>
      </div>
