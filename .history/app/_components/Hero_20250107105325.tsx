  ...
  return (
    <Section className="flex items-start gap-3 py-0 max-md:flex-col">
      <div className="flex flex-[2] flex-col gap-2">
        ...
        <button
          type="button"
          className="flex items-center gap-2h-14 w-48 rounded-2xl bg-primary/15 text-center font-sans text-xl font-semibold ring-1 cursor-pointer hover:bg-primary/30"
